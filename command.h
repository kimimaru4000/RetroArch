...
enum event_command
{
   ...
   CMD_EVENT_SAVE_STATE_SLOT_1,
   CMD_EVENT_SAVE_STATE_SLOT_2,
   CMD_EVENT_SAVE_STATE_SLOT_3,
   CMD_EVENT_SAVE_STATE_SLOT_4,
   CMD_EVENT_SAVE_STATE_SLOT_5,
   CMD_EVENT_SAVE_STATE_SLOT_6,
   CMD_EVENT_LOAD_STATE_SLOT_1,
   CMD_EVENT_LOAD_STATE_SLOT_2,
   CMD_EVENT_LOAD_STATE_SLOT_3,
   CMD_EVENT_LOAD_STATE_SLOT_4,
   CMD_EVENT_LOAD_STATE_SLOT_5,
   CMD_EVENT_LOAD_STATE_SLOT_6,
};
...
static const struct cmd_map map[] = {
   ...
   { "SAVE_STATE_1",           RARCH_SAVE_STATE_1_KEY },
   { "SAVE_STATE_2",           RARCH_SAVE_STATE_2_KEY },
   { "SAVE_STATE_3",           RARCH_SAVE_STATE_3_KEY },
   { "SAVE_STATE_4",           RARCH_SAVE_STATE_4_KEY },
   { "SAVE_STATE_5",           RARCH_SAVE_STATE_5_KEY },
   { "SAVE_STATE_6",           RARCH_SAVE_STATE_6_KEY },
   { "LOAD_STATE_1",           RARCH_LOAD_STATE_1_KEY },
   { "LOAD_STATE_2",           RARCH_LOAD_STATE_2_KEY },
   { "LOAD_STATE_3",           RARCH_LOAD_STATE_3_KEY },
   { "LOAD_STATE_4",           RARCH_LOAD_STATE_4_KEY },
   { "LOAD_STATE_5",           RARCH_LOAD_STATE_5_KEY },
   { "LOAD_STATE_6",           RARCH_LOAD_STATE_6_KEY },
