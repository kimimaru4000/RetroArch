...
static const struct input_bind_map input_config_bind_map[RARCH_BIND_LIST_END_NULL] = {
      ...
      DECLARE_META_BIND(1, save_state_1,          RARCH_SAVE_STATE_1_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_1_KEY),
      DECLARE_META_BIND(1, save_state_2,          RARCH_SAVE_STATE_2_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_2_KEY),
      DECLARE_META_BIND(1, save_state_3,          RARCH_SAVE_STATE_3_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_3_KEY),
      DECLARE_META_BIND(1, save_state_4,          RARCH_SAVE_STATE_4_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_4_KEY),
      DECLARE_META_BIND(1, save_state_5,          RARCH_SAVE_STATE_5_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_5_KEY),
      DECLARE_META_BIND(1, save_state_6,          RARCH_SAVE_STATE_6_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_SAVE_STATE_6_KEY),
      DECLARE_META_BIND(1, load_state_1,          RARCH_LOAD_STATE_1_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_1_KEY),
      DECLARE_META_BIND(1, load_state_2,          RARCH_LOAD_STATE_2_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_2_KEY),
      DECLARE_META_BIND(1, load_state_3,          RARCH_LOAD_STATE_3_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_3_KEY),
      DECLARE_META_BIND(1, load_state_4,          RARCH_LOAD_STATE_4_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_4_KEY),
      DECLARE_META_BIND(1, load_state_5,          RARCH_LOAD_STATE_5_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_5_KEY),
      DECLARE_META_BIND(1, load_state_6,          RARCH_LOAD_STATE_6_KEY,      MENU_ENUM_LABEL_VALUE_INPUT_META_LOAD_STATE_6_KEY),
