...
enum
{
   ...
   RARCH_SAVE_STATE_1_KEY,
   RARCH_SAVE_STATE_2_KEY,
   RARCH_SAVE_STATE_3_KEY,
   RARCH_SAVE_STATE_4_KEY,
   RARCH_SAVE_STATE_5_KEY,
   RARCH_SAVE_STATE_6_KEY,
   RARCH_LOAD_STATE_1_KEY,
   RARCH_LOAD_STATE_2_KEY,
   RARCH_LOAD_STATE_3_KEY,
   RARCH_LOAD_STATE_4_KEY,
   RARCH_LOAD_STATE_5_KEY,
   RARCH_LOAD_STATE_6_KEY,
